...
{
    // HACK: member q_static_assert_result151: name space empty, not QtPrivate like all other q_static_assert_result<some_int>
    // the correct place to fix would be in the parser but I couldn't find where
